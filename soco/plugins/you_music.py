...
""" Plugin for the YouMusic music service (Service ID 50) """
...
def _get_header(soap_action):
    ...
    # POST /yousee/musicopen.svc HTTP/1.1
    # CONNECTION: close
    # ACCEPT-ENCODING: gzip
    # HOST: moapi.247api.net
    # USER-AGENT: Linux UPnP/1.0 Sonos/24.1-75100 (WDCR:Microsoft Windows NT 6.1.7601 Service Pack 1)
    # CONTENT-LENGTH: 460
...
class YouMusic(SoCoPlugin):
    ...
    def __init__(self, soco, username, retries=3, timeout=3.0):
        ...
        Danish)
        """
        super(YouMusic, self).__init__(soco)

        # Instantiate variables
        # Possibly also: /yousee/musicopen.svc
        self._url = 'http://moapi.247api.net/yousee/musicopen.svc'
    ...
    def name(self):
        ...
        return 'YouMusic Plugin for {0}'.format(self._username)
    ...
    def description(self):
        ...
        """
        return 'SA_RINCON12807_{0}'.format(self._username)
